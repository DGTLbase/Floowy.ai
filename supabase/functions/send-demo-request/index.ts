...
interface DemoRequestEmailRequest {
  name: string;
  email: string;
  company: string;
  role?: string;
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const { name, email, company, role, message }: DemoRequestEmailRequest = await req.json();
    ...
    console.log("Processing demo request from:", email);
                  ...
                  <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                      <td style="padding: 40px 40px 20px;">
                        <h2 style="margin: 0 0 24px; color: #1a1a1a; font-size: 24px; font-weight: 600;">New Demo Request</h2>
                        ...
                        <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; margin-top: 24px; border-radius: 4px;">
                          <p style="margin: 0; color: #92400e; font-size: 14px; line-height: 1.6;">
                            <strong>Action Required:</strong> Please reach out within 1-3 business days to schedule their demo session.
                          </p>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      <td style="padding: 20px 40px 40px; border-top: 1px solid #e2e8f0;">
                        <p style="margin: 0; color: #94a3b8; font-size: 14px; text-align: center;">This demo request was sent from the Floowy.ai website</p>
                      </td>
                    </tr>
                  </table>
                </td>
    ...
    if (!teamEmailResponse.ok) {
      ...
      throw new Error("Failed to send demo request to team");
    }

    console.log("Demo request email sent to team successfully");
    ...
    const confirmationEmailResponse = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Floowy.ai <hello@floowy.ai>",
        to: [email],
        subject: "Your Floowy.ai Demo Request - We'll be in touch soon!",
        html: `
          <!DOCTYPE html>
          <html>
          <head>
                  ...
                  <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    ...
                    <tr>
                      <td style="padding: 40px;">
                        ...
                        <p style="margin: 0 0 20px; color: #475569; font-size: 16px; line-height: 1.6;">We're excited to show you how Floowy.ai can transform your marketing content creation.</p>
                        
                        <div style="background-color: #f0fdf4; border-left: 4px solid #22c55e; padding: 20px; margin: 24px 0; border-radius: 4px;">
                          <h2 style="margin: 0 0 12px; color: #166534; font-size: 18px; font-weight: 600;">What happens next?</h2>
                          <p style="margin: 0; color: #166534; font-size: 15px; line-height: 1.6;">Our team will reach out within <strong>1-3 business days</strong> to schedule your personalized demo session.</p>
                        </div>
                        
                        <h2 style="margin: 32px 0 16px; color: #1a1a1a; font-size: 20px; font-weight: 600;">During your demo, you'll see:</h2>
                        <ul style="margin: 0 0 24px; padding-left: 24px; color: #475569; font-size: 15px; line-height: 1.8;">
                          <li>How to create stunning atmospheric product photos in seconds</li>
                          <li>Generate professional fashion photography with AI models</li>
                          <li>Create authentic UGC videos without hiring creators</li>
                          <li>Transform product ideas into reality with AI</li>
                        </ul>
                        
                        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-radius: 8px; padding: 24px; margin: 32px 0;">
                          <p style="margin: 0 0 16px; color: #ffffff; font-size: 18px; font-weight: 600;">Explore Our Success Stories</p>
                          <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                              <td style="padding: 8px 0;">
                                <a href="https://floowy.ai/cases/welhof" style="color: #ffffff; text-decoration: none; font-size: 15px;">📈 <strong>Welhof Case Study</strong> - +22% Conversion Rate</a>
                              </td>
                            </tr>
                            <tr>
                              <td style="padding: 8px 0;">
                                <a href="https://floowy.ai/cases/reloadbase" style="color: #ffffff; text-decoration: none; font-size: 15px;">🚀 <strong>ReloadBase Case Study</strong> - +14% Conversion Rate</a>
                              </td>
                            </tr>
                          </table>
                        </div>
                        
                        <p style="margin: 24px 0; color: #475569; font-size: 15px; line-height: 1.6;">If you have any questions before the demo, feel free to reply to this email.</p>
                        
                        <div style="background-color: #fef3c7; border-radius: 8px; padding: 20px; margin: 24px 0; text-align: center;">
                          <p style="margin: 0 0 12px; color: #92400e; font-size: 14px; font-weight: 600;">Can't wait to get started?</p>
                          <a href="https://floowy.ai/auth?mode=signup" style="display: inline-block; background-color: #22c55e; color: #ffffff; text-decoration: none; padding: 12px 32px; border-radius: 6px; font-weight: 600; font-size: 15px;">Start Free Trial - Get 3 Free Credits</a>
                        </div>
